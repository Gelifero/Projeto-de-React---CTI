...
const dadosCatalogo: Categoria[] = [
  {
    ...
    nome: 'Ação',
    filmes: [
      { id: '1', titulo: 'Como Treinar o Seu Dragão', ano: '2010', imagem: 'https://www.papodecinema.com.br/wp-content/uploads/2012/02/20181217-como-treinar-o-seu-dragao-2578-poster.webp' },
      { id: '2', titulo: 'Vingadores', ano: '2014', imagem: 'https://m.media-amazon.com/images/I/71aLwVNGplL._AC_UF894,1000_QL80_.jpg' },
    ],
  },
  {
    id: '2',
    nome: 'Comédia',
    filmes: [
      { id: '3', titulo: 'O máscara', ano: '2013', imagem: 'https://br.web.img2.acsta.net/medias/nmedia/18/90/86/15/20116705.jpg' },
      { id: '4', titulo: 'Deadpool', ano: '2016', imagem: 'https://lumiere-a.akamaihd.net/v1/images/image_8c4aa72b.jpeg' },
    ],
  },
  {
    id: '3',
    nome: 'Terror',
    filmes: [
      { id: '5', titulo: 'O Chamado', ano: '1972', imagem: 'https://br.web.img2.acsta.net/pictures/17/01/05/22/10/519378.jpg' },
      { id: '6', titulo: 'Longlegs', ano: '2025', imagem: 'https://ingresso-a.akamaihd.net/prd/img/movie/longlegs-vinculo-mortal/3b62f39c-8b5c-42a2-925a-8126749d8466.webp' },
    ],
  },
];
